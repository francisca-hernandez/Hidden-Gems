...
const Gemsform = () => {
  // What input is required in the form
  ...
  return (
    <section>
      <div>
        <div>
          <h5>
            Noun. Hidden gem (plural hidden gems) Something possessing a value
            or beauty that is not immediately apparent,
          </h5>
          <h5>
            {' '}
            which therefore has received far less recognition than it deserves.
          </h5>
          ...
          <div>
            <Form onSubmit={handleFormSubmit}>
              ...
              <FormGroup></FormGroup>
              {/* Submit button to add a new gem */}
              <Button
                style={{
                  fontWeight: 'bold',
                }}
